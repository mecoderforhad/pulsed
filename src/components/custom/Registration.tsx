            ...
            <form onSubmit={onSubmit} className="w-full max-w-md space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full mb-1 px-4 py-2 rounded-lg border border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none bg-transparent text-white"
